...
class PerspTransDetector2(nn.Module):
    def __init__(self, dataset, arch='resnet18'):
        ...
        # self.se_module = LightweightSE(self.C).to('cuda:0')
        ...
        self.downsample = nn.Sequential(
                                        ...
                                        # nn.Conv2d(downsample_in_channels, hidden_dim, 3, 2, 1), 
                                        nn.Conv2d(self.C, hidden_dim, 3, 2, 1), 
        ...
        self.map_classifier = nn.Sequential(
                                            # nn.Conv2d(1 * self.num_cam * self.pronums + 2, 512, 3, padding=1), nn.ReLU(),
    ...
    def forward(self, imgs, visualize=False):
        ...
        # world_features = self.se_module(world_features)
    ...
    def get_imgcoord2worldgrid_matrices(self, worldgrid2worldcoord_mat, base_dataset=None):
        dataset = base_dataset or Wildtrack('./Data/Wildtrack_dataset')
